...
use app\modules\administrator\models\GalleryCategorySearch;
...
class GalleryCategoryController extends BaseController
{
    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new GalleryCategory",
                ...
                return [
                    ...
                    'title'=> "Create new GalleryCategory",
                    'content'=>'<span class="text-success">Create GalleryCategory success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Update GalleryCategory #".$id,
    ...
    /**
     * Delete an existing GalleryCategory model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing GalleryCategory model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
